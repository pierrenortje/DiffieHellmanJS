...
a[c].getAttribute("src");if(d=b.exec(d))n=d[1],p=d[2]}}();var h=function(){for(var b=0,a=arguments.length;b<a;b++){var c=arguments[b].split("."),c=n+c[0]+p+"."+c[1],e=document.querySelector('script[src="'+c+'"]');e||(e=document.createElement("script"),e.setAttribute("src",c),document.head.appendChild(e))}};c||h("gostRandom.min.js");g||h("gostCipher.min.js");k||h("gostDigest.min.js");l||h("gostSign.min.js")}return m});
